...
import type { Message as MessageType } from "~/lib/conversations";
...
export function MessageControls({
  conversation,
  msgs,
}: { conversation: Conversation[]; msgs: MessageType[] }) {
  const { t } = useTranslations();
    ...
    <div className="space-y-2">
      <div className="flex justify-between items-center">
        ...
        <Dialog>
          ...
          <DialogContent className="max-w-full p-4 overflow-y-auto top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
            <DialogHeader>
