  ...
  return (
    <div className="flex w-full gap-4 rounded-lg bg-muted p-4">
      ...
      <div className="flex min-w-0 flex-1 flex-col space-y-4">
        <div className="prose *:text-muted-foreground prose-pre:bg-secondary prose-code:text-secondary-foreground prose-code:bg-secondary prose-a:text-muted-foreground prose-strong:text-muted-foreground w-full break-words">
